...
class _Game1State extends State<Game1> {
  ...
  Future<void> _loadQuestions() async {
    try {
      final qs = await DBService.fetchQuestions("logic");
      setState(() {
        _questions = qs;
        _loading = false;
      });
...
//     },
//     {
//       "prompt": "Selecciona el sinónimo de 'rápido'",
//       "options": ["lento", "veloz", "pesado", "débil"],
//       "correctIndex": 1,
//     },
//     {
//       "prompt": "¿Cuál es 3 × 4?",
...
//     },
//     {
//       "prompt": "Elige la bandera de Francia",
//       "options": ["🇲🇽", "🇫🇷", "🇧🇷", "🇦🇷"],
//       "correctIndex": 1,
//     },
//   ];
...
//   void _onSelect(int index) {
//     if (_answered) return; // no permitir cambiar después de responder
//     setState(() => _selected = index);
//   }
